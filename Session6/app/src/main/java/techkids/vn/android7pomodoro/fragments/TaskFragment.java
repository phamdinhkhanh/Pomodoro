...
import techkids.vn.android7pomodoro.fragmentmanager.ReplaceFragment;
...
public class TaskFragment extends Fragment {
    ...
    void onFabClick() {
        ...
        ReplaceFragment replaceFragment = new ReplaceFragment(this.getFragmentManager(),R.id.fl_main);
        replaceFragment.replanceFragment(new TaskDetailFragment(),R.id.fl_main,true);
    }
}
