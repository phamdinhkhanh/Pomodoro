...
public class TaskManager {
    ...
    public interface AddNewTaskListener{
        void onAddNewTask(boolean ok);
    }

    public AddNewTaskListener addNewTaskListener;

    public void setAddNewTaskListener(AddNewTaskListener addNewTaskListener) {
        this.addNewTaskListener = addNewTaskListener;
    }
        ...
        NetContext.instance
                  ...
                  .enqueue(new Callback<TaskResponseJson>() {
                      ...
                      public void onResponse(Call<TaskResponseJson> call, Response<TaskResponseJson> response) {
                          ...
                          addNewTaskListener.onAddNewTask(true);
                      }

                      @Override
                      public void onFailure(Call<TaskResponseJson> call, Throwable t) {
                          addNewTaskListener.onAddNewTask(false);
        ...
        NetContext.instance.create(EditTask.class)
                  ...
                  .enqueue(new Callback<TaskResponseJson>() {
                      ...
                      public void onResponse(Call<TaskResponseJson> call, Response<TaskResponseJson> response) {
                          ...
                          updateTaskListener.onUpdateTask(true);
                          };
                      }

                      @Override
                      public void onFailure(Call<TaskResponseJson> call, Throwable t) {
                          updateTaskListener.onUpdateTask(false);
