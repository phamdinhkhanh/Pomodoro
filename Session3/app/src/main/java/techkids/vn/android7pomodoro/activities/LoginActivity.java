...
public class LoginActivity extends AppCompatActivity {
    ...
    private void sendRegister(String username, String password) {
        ...
        //POST a json and should convert json to string
        String registerJson = new Gson().toJson(new RegisterBodyJson(username,password));
        //convert string to json for services are readable
        RequestBody registerBody = RequestBody.create(jsonMediaType,registerJson);
        //register registerBody and enqueue registerRespondJson
        registerService
                ...
                .enqueue(new Callback<RegisterResponseJson>() {
                    ...
                    public void onResponse(Call<RegisterResponseJson> call, Response<RegisterResponseJson> response) {
                        ...
                        if (registerResponseJson == null) {
                            Log.d(TAG, "user or password invalid");
                            onRegisterFailure();
                        } else {
                            Log.d(TAG, String.format("onResponse, oh yeah: %s", registerResponseJson));
    ...
    private void sendLogin(String username, String password) {
        //Tao loginService gom POST va Call Respond.
        ...
        //Tao kieu cua json.
        MediaType jsonMediaType = MediaType.parse("application/json");
        //chuyen LoginBodyJson ve dang String
        ...
        loginService
                ...
                .enqueue(new Callback<LoginResponseJson>() {
                    ...
                    public void onResponse(Call<LoginResponseJson> call, Response<LoginResponseJson> response) {
                        //goi loginBody tra ve loginRespondJson
    ...
    private void onRegisterFailure(){
        Toast.makeText(this, "user or password already registered", Toast.LENGTH_SHORT).show();
    }
